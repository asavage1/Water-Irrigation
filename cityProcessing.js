...
var result = function(i, angle) {
	...
	document.getElementById("result").style["-ms-transform"]= "rotate(" +angle+"rad)"; /* IE 9 */
    document.getElementById("result").style["-webkit-transform"]= "rotate(" + angle + "rad)"; /* Chrome, Safari, Opera */
